...
class Plateau {
	...
	public Plateau(boolean cheat) throws ErreurCoordonneesException, CouleurPieceException, CaseOccupeeException {
	...
	public void deplacer(Position from, Position to)
			throws ErreurCoordonneesException, CouleurPieceException, ErreurDeplacementException {
	...
	public static void main(String[] args)
			throws ErreurCoordonneesException, CouleurPieceException, CaseOccupeeException {
